...
#ifndef MANGOH_LEDGPIO_INTERFACE_H_INCLUDE_GUARD
#define MANGOH_LEDGPIO_INTERFACE_H_INCLUDE_GUARD
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef void (*mangoh_ledGpio_DisconnectHandler_t)(void *);
...
typedef enum
{
    MANGOH_LEDGPIO_ACTIVE_HIGH = 0,
        ///< GPIO active-high, output is 1
    MANGOH_LEDGPIO_ACTIVE_LOW = 1
        ///< GPIO active-low, output is 0
}
mangoh_ledGpio_Polarity_t;
...
typedef enum
{
    MANGOH_LEDGPIO_EDGE_NONE = 0,
        ///< No edge detection
    MANGOH_LEDGPIO_EDGE_RISING = 1,
        ///< Notify when voltage goes from low to high.
    MANGOH_LEDGPIO_EDGE_FALLING = 2,
        ///< Notify when voltage goes from high to low.
    MANGOH_LEDGPIO_EDGE_BOTH = 3
        ///< Notify when pin voltage changes state in either direction.
}
mangoh_ledGpio_Edge_t;


//--------------------------------------------------------------------------------------------------
/**
 * Reference type used by Add/Remove functions for EVENT 'mangoh_ledGpio_ChangeEvent'
 */
//--------------------------------------------------------------------------------------------------
typedef struct mangoh_ledGpio_ChangeEventHandler* mangoh_ledGpio_ChangeEventHandlerRef_t;
...
typedef enum
{
    MANGOH_LEDGPIO_PULL_OFF = 0,
        ///< Neither resistor is enabled
    MANGOH_LEDGPIO_PULL_DOWN = 1,
        ///< Pulldown resistor is enabled
    MANGOH_LEDGPIO_PULL_UP = 2
        ///< Pullup resistor is enabled
}
mangoh_ledGpio_PullUpDown_t;
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef void (*mangoh_ledGpio_ChangeCallbackFunc_t)
(
    bool state,
...
#endif // MANGOH_LEDGPIO_INTERFACE_H_INCLUDE_GUARD