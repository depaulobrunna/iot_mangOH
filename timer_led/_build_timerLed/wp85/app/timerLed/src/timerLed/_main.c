...
// Startup code for the executable 'timerLed'.
...
LE_SHARED const char* _timerLedComponent_mangoh_ledGpio_ServiceInstanceName = "timerLed.timerLedComponent.mangoh_ledGpio";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t timerLed_exe_LogSession;
LE_SHARED le_log_Level_t* timerLed_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    timerLed_exe_LogSession = log_RegComponent("timerLed_exe", &timerLed_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_timerLedComponent.so");
