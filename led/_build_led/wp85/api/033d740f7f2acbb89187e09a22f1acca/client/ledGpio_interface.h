...
#ifndef LEDGPIO_INTERFACE_H_INCLUDE_GUARD
#define LEDGPIO_INTERFACE_H_INCLUDE_GUARD
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef void (*ledGpio_DisconnectHandler_t)(void *);
...
typedef enum
{
    LEDGPIO_ACTIVE_HIGH = 0,
        ///< GPIO active-high, output is 1
    LEDGPIO_ACTIVE_LOW = 1
...
typedef enum
{
    LEDGPIO_EDGE_NONE = 0,
        ///< No edge detection
    LEDGPIO_EDGE_RISING = 1,
        ///< Notify when voltage goes from low to high.
    LEDGPIO_EDGE_FALLING = 2,
...
//--------------------------------------------------------------------------------------------------
/**
 * Reference type used by Add/Remove functions for EVENT 'ledGpio_ChangeEvent'
 */
//--------------------------------------------------------------------------------------------------
typedef struct ledGpio_ChangeEventHandler* ledGpio_ChangeEventHandlerRef_t;
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef void (*ledGpio_ChangeCallbackFunc_t)
(
    bool state,
...
#endif // LEDGPIO_INTERFACE_H_INCLUDE_GUARD