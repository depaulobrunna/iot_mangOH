...
// Startup code for the executable 'led'.
...
LE_SHARED const char* _ledComponent_ledGpio_ServiceInstanceName = "led.ledComponent.ledGpio";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t led_exe_LogSession;
LE_SHARED le_log_Level_t* led_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    led_exe_LogSession = log_RegComponent("led_exe", &led_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_ledComponent.so");
