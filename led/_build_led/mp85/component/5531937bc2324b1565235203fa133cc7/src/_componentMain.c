...
extern const char* _ledComponent_ledGpio_ServiceInstanceName;
const char** ledGpio_ServiceInstanceNamePtr = &_ledComponent_ledGpio_ServiceInstanceName;
void ledGpio_ConnectService(void);
