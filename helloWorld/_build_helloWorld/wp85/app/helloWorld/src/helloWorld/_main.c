...
// Startup code for the executable 'helloWorld'.
...
LE_SHARED le_log_SessionRef_t helloWorld_exe_LogSession;
LE_SHARED le_log_Level_t* helloWorld_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    helloWorld_exe_LogSession = log_RegComponent("helloWorld_exe", &helloWorld_exe_LogLevelFilterPtr);
