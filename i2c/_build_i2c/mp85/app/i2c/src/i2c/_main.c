...
// Startup code for the executable 'i2c'.
...
LE_SHARED le_log_SessionRef_t i2c_exe_LogSession;
LE_SHARED le_log_Level_t* i2c_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    i2c_exe_LogSession = log_RegComponent("i2c_exe", &i2c_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_i2cComponent.so");
